        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            if (stats != null) {
                ...
                for(Long val : mySortedMap.keySet()){
                    ...
                    Date d1 = new Date(mySortedMap.get(val).getFirstTimeStamp());
                    Date d2 = new Date(mySortedMap.get(val).getLastTimeStamp());

                    Log.e(TAG, ""+mySortedMap.get(val).getPackageName()+ " "+ d1+ " @@ "+ d2);
                }
...
// start of the day <-> current time of the day
